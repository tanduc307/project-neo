...
rice_country <- rice_country |> subset(area != "Micronesia (Federated States of)")
rice_country <- rice_country |> subset(area != "Mauritius")
rice_country <- rice_country |> subset(area != "Syrian Arab Republic")
...
Cairo::CairoPNG(
    width = 1728, #length
    height = 123*3456/128, #width
    file = paste("nameofplot21-c-mai", ".png", sep = ""),
    # type = "png", #tiff
